...
const values: {
	...
	},
	{
		...
		description:
			"Optional USDC settlement uses exact user approvals. Filosign never holds your funds.",
...
export default function ValuesSectionIsland() {
	return (
		<MotionProvider>
			<section className="bg-background px-8 py-24 md:px-page">
				<div className="mx-auto max-w-7xl">
					...
					<div className="grid gap-8 lg:grid-cols-2 lg:items-stretch">
						...
						<motion.div
							...
							viewport={{ once: true }}
							className="relative min-h-[420px] overflow-hidden rounded-3xl lg:min-h-full"
						>
							<img
