...
4. Use the [independent verifier](https://verify.filosign.xyz) to check the ZIP against the public ledger. Open `proofs/` only if an expert wants raw verification files.
