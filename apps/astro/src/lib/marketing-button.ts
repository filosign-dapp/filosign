...
export const marketingPrimaryLgClass = [
	"group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-base font-medium whitespace-nowrap select-none h-12 gap-2 px-8 bg-primary text-primary-foreground hover:bg-primary/90 w-full sm:w-auto",
	marketingButtonFocus,
	marketingButtonMotion,
].join(" ");

export const marketingGhostLgClass = [
	"group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-border bg-clip-padding text-base font-medium whitespace-nowrap select-none h-12 gap-2 px-8 text-foreground hover:bg-muted w-full sm:w-auto",
	marketingButtonFocus,
	marketingButtonMotion,
].join(" ");
...
export const marketingPrimaryMdClass = [
	"group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap select-none h-10 gap-1.5 px-6 bg-primary text-primary-foreground hover:bg-primary/90",
	marketingButtonFocus,
	marketingButtonMotion,
].join(" ");
