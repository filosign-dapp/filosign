...
> = {
	...
	"features.settlement.basic": {
		title: "Payments need a paid plan",
		description:
			"Upgrade to Solo or higher, then request payment access in Workspace settings.",
	},
	...
	"features.routing.advanced": {
		title: "Advanced routing needs Teams Pro",
		description:
			"Use ordered signing, set turn order, and set minimum signatures (quorum) with Teams Pro or Enterprise.",
	},
	...
	"features.supplementary_attachments": {
		title: "Extra attachments need Solo or higher",
		description: "Send additional files with your envelope on Solo or higher.",
	},
	"features.supplementary_attachments.recipient_select": {
		title: "Choose who gets each attachment",
		description:
			"Pick which recipients receive each extra file with Teams or higher.",
	},
	"features.supplementary_attachments.conditional_release": {
		title: "Release files after signing needs Teams Pro",
		description:
			"Share files only after signing conditions are met with Teams Pro or Enterprise.",
	},
	"features.treasury.workspace_custom": {
		title: "Custom workspace treasury needs Teams Pro",
		description:
			"Use your workspace treasury as the payout wallet with Teams Pro or Enterprise. Solo and Teams can still send payouts from your account.",
	},
