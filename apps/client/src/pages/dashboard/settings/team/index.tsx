			...
			<div className="mx-auto max-w-2xl space-y-8 px-8 py-8">
				<div>
					...
					<p className="mt-1 text-sm text-muted-foreground">
						Create an organization to share connections, templates, and
				...
				<section className="space-y-4 rounded-lg border border-border p-6">
					...
					<p className="text-xs text-muted-foreground">
						Paste the invite token you received. Your Filosign profile email
				...
				{activeOrgId && canInviteMembers ? (
					<section className="space-y-4 rounded-lg border border-border p-6">
						...
						<p className="text-xs text-muted-foreground">
							...
							with your teammate. After they accept, use “Deliver org key” so
							they can open team documents.
						</p>
						<div className="flex flex-col gap-2 sm:flex-row">
							<Input
								type="email"
					...
					<section className="space-y-3 rounded-lg border border-border p-6">
						...
						<ul className="space-y-2 text-sm">
							{members.map((m) => {
								const isSelf =
									myWalletNorm &&
									m.walletAddress.toLowerCase() === myWalletNorm;
