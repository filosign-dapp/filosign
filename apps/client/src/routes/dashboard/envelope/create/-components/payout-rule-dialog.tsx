	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			...
			>
				<DialogHeader>
					<DialogTitle>
						{existingRuleId ? "Edit payout" : "Add payout"}
					</DialogTitle>
					<DialogDescription>
						Set when USDC is released, then choose Filosign recipients and
						amounts. Funds stay in your wallet until conditions are met.{" "}
