...
export function PdfAcroformImportDialog({
	...
	return (
		<ConfirmAlertDialog
			...
			description="This PDF contains native form fields. Import them as Filosign placement fields assigned to the active signer. You can adjust positions before sending. Native PDF fields remain in the file."
