export const definitions = {
	latest: {
		FSEnvelopeRegistry: {
			address: "0x1d898C152e0b528af30d2CfBA1b562b201845BBF",
			abi: [
				{
					inputs: [
						{
				...
				{
					inputs: [],
					name: "NoSignerReplacementPending",
					type: "error",
				},
				{
					inputs: [],
				...
				},
				{
					...
					name: "SignerReplacementCancelled",
					type: "event",
				},
				{
					anonymous: false,
					inputs: [
						...
						},
						{
							indexed: false,
							internalType: "uint8",
							name: "signaturesClearedCount",
							type: "uint8",
						},
					],
					name: "SignerReplacementExecuted",
					type: "event",
				},
				{
					anonymous: false,
					inputs: [
						...
						},
						{
							...
							name: "signersCommitmentAfter",
							type: "bytes20",
						},
					],
					name: "SignerReplacementProposed",
					type: "event",
				},
				{
					inputs: [],
				...
				},
				{
					...
					name: "getPendingSignerReplacement",
					outputs: [
						{
							internalType: "bool",
							name: "active",
						...
						{
							internalType: "bytes32",
							name: "routingOrderHashAfter",
							type: "bytes32",
						},
						{
							internalType: "bytes32",
							name: "quorumSetHashAfter",
							type: "bytes32",
						},
						{
							internalType: "bytes20",
		...
		FSPaymentValidator: {
			address: "0xDFfdBe02E4622fB8a66Ed834978B7932D2F70918",
			abi: [
				{
					inputs: [
						{
		...
		FSAttachmentRelease: {
			address: "0xA7f39bf1ab4E1b7A6787a11a8E8AE0ab951e8007",
			abi: [
				{
					inputs: [
						{
	...
	byAddress: {
		"0x1d898c152e0b528af30d2cfba1b562b201845bbf": {
		...
		"0xdffdbe02e4622fb8a66ed834978b7932d2f70918": {
		...
		"0xa7f39bf1ab4e1b7a6787a11a8e8ae0ab951e8007": {
