...
import {
	...
	rpcOrgsTemplateGetOutputSchema,
	rpcOrgsTemplateOutputSchema,
	rpcOrgsTemplatePrepareOutputSchema,
...
export const rpcOut = {
	...
	orgs: {
		...
		templateGet: rpcOrgsTemplateGetOutputSchema,
		templatePrepare: rpcOrgsTemplatePrepareOutputSchema,
