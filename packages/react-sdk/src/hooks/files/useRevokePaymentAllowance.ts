...
import { revokePaymentValidatorAllowance } from "../../lib/payment-rules";
import { useFilosignRpc } from "../../lib/use-filosign-rpc";

export function useRevokePaymentAllowance(_pieceCid: string | undefined) {
	...
	return useMutation({
		mutationFn: async (tokenAddress: Address) => {
			...
			return revokePaymentValidatorAllowance({
				wallet,
				contracts,
