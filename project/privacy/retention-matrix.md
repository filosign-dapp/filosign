...
|---|---|---|---|---|
| Signed legal evidence | `files`, `file_signatures`, `file_signer_amendments`, `file_acknowledgements`, compliance bundle records | legal/claims retention | immutable core; selective metadata redaction windows where lawful | never add product API hard delete |
